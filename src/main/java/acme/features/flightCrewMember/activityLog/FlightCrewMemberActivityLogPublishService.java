...
public class FlightCrewMemberActivityLogPublishService extends AbstractGuiService<FlightCrewMember, ActivityLog> {
	...
	public void authorise() {
		...
		status = log != null && log.getDraftMode() && log.getFlightAssignment() != null && !log.getFlightAssignment().getDraftMode() && log.getFlightAssignment().getFlightCrewMember().getId() == memberId;
